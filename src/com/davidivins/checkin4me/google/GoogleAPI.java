...
// * @author david ivins
// */
//public class GoogleAPI implements APIInterface
//{
...
//	 */
//	public GoogleAPI(Properties config, int service_id)
//	{
//		this.config = config;
...
//		public void run() 
//		{
//			Log.i(TAG, "Retrieving Google Locations");
//
...
//					persistent_storage.getString("google_oauth_token_secret", "GOOGLE_ACCESS_TOKEN_HERE"));
//			
...
//		public void run() 
//		{
//			Log.i(TAG, "Checking in on Google");
//
//			// build new oauth request
//			OAuth2Request request = new OAuth2Request(
...
//			if (persistent_storage.getBoolean("google_post_to_facebook_default", false))
//				broadcast += ",facebook";
//			
//			// if post to twitter is enabled, add it to broadcast
//			if (persistent_storage.getBoolean("google_post_to_twitter_default", false))
//				broadcast += ",twitter";
//
