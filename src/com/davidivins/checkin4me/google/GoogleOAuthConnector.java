...
//{
//	private static final String TAG      = "GoogleOAuthConnector";
...
//	 * @param config
//	 */
//	GoogleOAuthConnector(Properties config) 
//	{
//		this.config = config;
//		
//		try
...
//		persistent_storage_editor.putString("google_code", response.getQueryParameter("code"));
...
//		Log.i(TAG, "code = " + persistent_storage.getString("google_code", "-1"));
//		
//		if (persistent_storage.getString("google_code", null) != null)
//		{
...
//			request.addQueryParameterAndEncode("code", persistent_storage.getString("google_code", "CODE_HERE"));
//
...
//			persistent_storage_editor.putString("google_oauth_token_secret", json.getString("access_token"));
//			persistent_storage_editor.commit();
//		}
//		catch (Exception e)
//		{
...
//		persistent_storage_editor.remove("google_code");
//		persistent_storage_editor.commit();
//	}
//}
